...
import { BrowserRouter as Router, Route, Routes } from 'react-router-dom'; // Make sure to import react-router

function App() {
  // Állapotok
  const [searchTerm, setSearchTerm] = useState("");
  const [showModal, setShowModal] = useState(false);
  const [isLogin, setIsLogin] = useState(true); // Állapot, hogy a login vagy a sign-up formot jelenítse meg
